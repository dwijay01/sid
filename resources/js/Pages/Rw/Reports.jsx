...
import { FileBarChart, Printer, Users, Heart, ArrowRightLeft, ArrowDownToLine, Skull, Baby } from 'lucide-react';
...
export default function Reports({ data, type }) {
    ...
    const handleSwitch = (newType) => {
        ...
        router.get(route('rw.reports'), { type: newType }, { preserveState: true });
    };
